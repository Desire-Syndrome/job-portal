					...
					<tbody>
						{applicants.map((applicant, i) => (
							<tr key={i} className='text-gray-700'>
								<td className='py-2 px-2 bordeb-b text-center max-sm:hidden'>{i + 1}</td>
								<td className='py-2 px-2 bordeb-b flex items-center'>
									<img src={applicant.imgSrc} alt="User avatar" className='w-10 h-10 rounded-full mr-3 ' />
									<span>{applicant.name}</span>
								</td>
								<td className='py-2 px-2 bordeb-b max-lg:hidden'>
								...
								<td className='py-2 px-2 bordeb-b max-xl:hidden'>{applicant.location}</td>
								<td className='py-2 px-2 bordeb-b'>
								...
								<td className='py-2 px-2 border-b relative w-[100px] max-sm:w-[60px]'>
