							...
							<div className='relative group'>
								...
								<div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12'>
									<ul className='list-none m-0 p-2 bg-white rounded-md border text-sm w-max'>
										...
										<li><Link to={'/dashboard/add-job'} className='py-1 px-2 cursor-pointer flex items-center gap-2 hover:bg-blue-100'>
											<img src={assetsImages.home_icon} className='w-4 h-4' alt="icon" />To Dashboard
										</Link></li>
										<li><Link to={'/dashboard/edit-company-profile'} className='py-1 px-2 cursor-pointer flex items-center gap-2 hover:bg-blue-100'>
